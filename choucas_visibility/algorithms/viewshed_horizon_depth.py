...
##            defaultValue=1))
    ...
    def name(self):
        ...
        return 'Calcul de la hauteur dbh  depth below horizon à partir du point d observation et du MNT '
    ...
    def groupId(self):
        ...
        formatting characters.
        """
        return 'Calcul de zone de visibilité'
